/*! EnlighterJS Syntax Highlighter 2.13.0 | MIT License (X11) | https://enlighterjs.org/ | December 29 2018 */ ! function () {
    var e = window.EnlighterJS = new Class({
        ...
        enlight: function (t) {
            if (t) {
                ...
                }), this.output.addClass(s.toLowerCase() + "EnlighterJS").addClass("EnlighterJS"), "Block" == this.options.renderer ? (this.container || (this.container = new e.Dom.Element("div"), this.container.inject(this.originalCodeblock, "after")), this.container.addClass("EnlighterJSWrapper").addClass(s.toLowerCase() + "EnlighterJSWrapper"), this.container.grab(this.output), this.rawContentContainer = new e.Dom.Element("pre", {
                    text: this.getRawCode(!1),
                    styles: {
                        display: "none"
                    }
                }), this.container.grab(this.rawContentContainer), this.options.rawcodeDoubleclick && this.container.addEvent("dblclick", function () {
                    this.toggleRawCode()
                }.bind(this)), (this.options.rawButton || this.options.windowButton || this.options.infoButton) && this.container.grab(new e.UI.Toolbar(this))) : this.container ? this.container.grab(this.output) : (this.output.inject(this.originalCodeblock, "after"), this.container = this.output), this.isRendered = !0
        ...
        getRawCode: function (e) {
            ...
            if (null == t && (t = this.originalCodeblock.get("html"), t = t.replace(/(^\s*\n|\n\s*$)/gi, ""), t = this.textFilter.filterInput(t), this.options.ampersandCleanup === !0 && (t = t.replace(/&amp;/gim, "&")), t = t.replace(/&lt;/gim, "<").replace(/&gt;/gim, ">").replace(/&nbsp;/gim, " "), this.rawCode = t), e === !0) {
                ...
                n > -1 && (t = t.replace(/(\t*)/gim, function (e, t, a, s) {
    ...
    e.Language = {}, e.Tokenizer = {}, e.Renderer = {}, e.Util = {}, e.UI = {}, e.TextFilter = new Class({
        Implements: Options,
        options: {
            cryptex: {
                enabled: !1,
        ...
        filterInput: function (e) {
            return this.options.cryptex.enabled === !0 && (e = e.replace(/<!--CTX!--><span (rel="([a-f0-9]+)")?[\s\S]*?<!--\/CTX!-->/gim, function (e, t, n, a, s) {
    ...
    }, e.Dom.Element = Element, e.SpecialLineHighlighter = new Class({
        specialLines: {},
                ...
                a.each(function (e, t) {
                    ...
                    if (null != a) {
                        var s = a[1].toInt() - n,
                            i = a[2].toInt() - n;
                        if (i > s)
                            for (var r = s; i >= r; r++) this.specialLines["l" + r] = !0
        ...
        getLanguage: function (t) {
            ...
            return this.languageAliases[n] && (n = this.languageAliases[n]), "" != n.trim() && e.Language[n] || (n = "generic"), null == t || "" == t.trim() ? n : (t = t.trim().toLowerCase(), this.languageAliases[t] && (t = this.languageAliases[t]), e.Language[t] ? t : n)
        }
        ...
        textFilter: null,
        initialize: function (e, t) {
            this.setOptions(e), this.textFilter = t
        },
        ...
        render: function (t, n, a) {
            var s = e.Dom.Element,
                i = this.options.showLinenumbers ? "ol" : "ul";
            if (null !== a.lineNumbers) {
                var r = a.lineNumbers.toLowerCase();
                "true" === r ? i = "ol" : "false" === r && (i = "ul")
            }
            var o = new s(i);
            (a.lineNumbers || this.options.showLinenumbers) && a.lineOffset && a.lineOffset.toInt() > 1 && o.set("start", a.lineOffset);
            var l = 1,
                c = t.getTokens(),
                m = " " + this.options.oddClassname || "",
                g = " " + this.options.evenClassname || "",
                u = new s("li", {
                    "class": (n.isSpecialLine(l) ? "specialline" : "") + m
                }),
                p = function (e, t) {
                    u.grab(new s("span", {
                        "class": e,
            ...
            return Array.each(c, function (e) {
                var t = e.text.split("\n");
                t.length > 1 ? (p(e.alias, t.shift()), Array.each(t, function (t, a) {
                    o.grab(u), l++, u = new s("li", {
                        "class": (n.isSpecialLine(l) ? "specialline" : "") + (l % 2 == 0 ? g : m)
                    }), p(e.alias, t)
                })) : p(e.alias, e.text)
            }), o.grab(u), this.options.hover && "NULL" != this.options.hover && o.addClass(this.options.hover), o
        }
        ...
        getTokens: function (e, t) {
            var n = function (e, t, n) {
                ...
                s = [];
            Array.each(e.getRules(), function (e) {
                for (var s; s = e.pattern.exec(t);)
                    if (e.pattern.lastIndex = s.index + 1, 1 == s.length) a.push(n(s[0], e.alias, s.index));
                    else
                        for (var i = 1; i < s.length; i++) s[i] && s[i].length > 0 && a.push(n(s[i], e.alias, s.index + s[0].indexOf(s[i])))
            }), a = a.sort(function (e, t) {
                return e.index - t.index
            });
            for (var s = [], i = 0, r = 0; r < a.length; r++) {
                i < a[r].index && s.push(n(t.substring(i, a[r].index), "", i)), s.push(a[r]), i = a[r].end;
                for (var o = !1, l = r + 1; l < a.length; l++)
                    if (a[l].index >= i) {
                        r = l - 1, o = !0;
                        break
                    } if (o === !1) break
            }
            return i < t.length && s.push(n(t.substring(i), "", i)), s
        },
        ...
        code: null,
        getTokens: function (e, t) {
            return this.code = t, this.parent(e, t)
        },
        getPreprocessedTokens: function (e) {
            for (var t = [], n = /((?:\&lt;|<)[A-Z:_][A-Z0-9:._-]*)([\s\S]*?)(\/?(?:\&gt;|>))/gi, a = /\b([\w:-]+)([ \t]*)(=)([ \t]*)(['"][^'"]+['"]|[^'" \t]+)/gi, s = null, i = null, r = 0; null != (s = n.exec(this.code));) {
                for (t.push(e(s[1], "kw1", s.index)); null != (i = a.exec(s[2]));) r = s.index + s[1].length + i.index, t.push(e(i[1], "kw2", r)), r += i[1].length + i[2].length, t.push(e(i[3], "kw1", r)), r += i[3].length + i[4].length, t.push(e(i[5], "st0", r));
        ...
        t.document.body.innerHTML = "<pre>" + e + "</pre>", t.document.title = "EnlighterJS Sourcecode"
        ...
        initialize: function (t) {
            // this.setOptions(t.options), this.container = new e.Dom.Element("div", {
            ...
            this.setOptions(t.options), this.container = new e.Dom.Element("div", {
                ...
                "class": "_EnlighterJSWindowButton",
                title: this.options.toolbar.windowTitle,
                events: {
                    click: function () {
                        e.UI.CodeWindow(t.getRawCode(!1))
        ...
        enlight: function (t) {
            t = "undefined" == typeof t ? {} : t, t = t === !0 ? {} : t;
        ...
        if (!(null == t || t.length && 0 == t.length))
            if (n = n || {}, n.grouping && n.grouping === !1) t.enlight(n);
            else {
                var a = {},
                    s = [];
                Array.each(t, function (e) {
                    ...
                    e.enlight(n)
                }), Object.each(a, function (t) {
                    var a = Object.clone(n);
                    a.forceTheme = !0, a.theme = t[0].get("data-enlighter-theme") || n.theme || "Enlighter";
                    var s = new e.UI.TabPane(a.theme);
                    Array.each(t, function (t, n) {
                        var i = s.addTab(t.get("data-enlighter-title") || t.get("data-enlighter-language") || a.language);
                        new e(t, a, i).enlight(!0)
                    }.bind(this)), s.getContainer().inject(t[0], "before"), s.selectTab(0)
                }.bind(this))
            }
        ...
        initialize: function (t) {
            ...
            }), this.controlContainer = new e.Dom.Element("ul"), this.paneContainer = new e.Dom.Element("div", {
                "class": "pane"
            });
            var n = new e.Dom.Element("div", {
                "class": "controls"
            });
            n.grab(this.controlContainer), this.container.grab(n), this.container.grab(this.paneContainer)
        },
        ...
        addTab: function (t) {
            ...
            return this.paneContainer.grab(s), this.tabs.push({
                control: n,
                pane: s
            }), s
        },
        ...
        if (t) {
            ...
            "NULL" != a && (n.renderer = "Block", e.Util.Helper(e.Dom.getElements(a), n)), "NULL" != s && (n.renderer = "Inline", n.grouping = !1, e.Util.Helper(e.Dom.getElements(s), n))
        }
    }), e.Util.Init = function (t, n, a) {
        a = a || {}, t && (a.renderer = "Block", e.Util.Helper(e.Dom.getElements(t), a)), n && (a.renderer = "Inline", a.grouping = !1, e.Util.Helper(e.Dom.getElements(n), a))
        ...
        initialize: function (e) {
            this.setupLanguage(), this.rules = [], this.code = e, this.tokenizer = new EnlighterJS.Tokenizer[this.tokenizerType], this.delimiters.start && this.rules.push({
                pattern: this.delimiters.start,
                alias: "de1"
            }), this.delimiters.end && this.rules.push({
                pattern: this.delimiters.end,
                alias: "de2"
            }), Object.each(this.keywords, function (e, t) {
                "" != e.csv && this.rules.push({
                    pattern: this.csvToRegExp(e.csv, e.mod || "g"),
                    alias: e.alias
                })
            }, this), Object.each(this.patterns, function (e, t) {
                this.rules.push(e)
            }, this)
        },
        ...
        delimToRegExp: function (e, t, n, a, s) {
            e = e.escapeRegExp(), t && (t = t.escapeRegExp()), n = n ? n.escapeRegExp() : e;
            var i = t ? e + "[^" + n + t + "\\n]*(?:" + t + ".[^" + n + t + "\\n]*)*" + n : e + "[^" + n + "\\n]*" + n;
            return new RegExp(i + (s || ""), a || "")
        },
        strictRegExp: function () {
            for (var e = "(", t = 0; t < arguments.length; t++) e += arguments[t].escapeRegExp(), e += t < arguments.length - 1 ? "|" : "";
            return e += ")", new RegExp(e, "gim")
        }
