...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			...
			<div class="nav-previous">ttt<?php previous_comments_link( __( '&larr; Older Comments', 'sydney' ) ); ?></div>
			<div class="nav-next">eee<?php next_comments_link( __( 'Newer Comments &rarr;', 'sydney' ) ); ?></div>
